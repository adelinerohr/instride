...
export namespace availability {
    ...
    export class ServiceClient {
         ...
         */
        public async updateOrganizationBusinessHours(params: business_hours.UpdateOrganizationBusinessHoursParams): Promise<types.ListBusinessHoursResponse> {
            // Now make the actual call to the API
         ...
         */
        public async updateTrainerBusinessHours(trainerId: string, params: business_hours.UpdateTrainerBusinessHoursParams): Promise<types.ListBusinessHoursResponse> {
            // Now make the actual call to the API
...
export namespace guardians {
    ...
    reason?: string
        ...
        public async getInvitationByToken(token: string): Promise<types.GuardianInvitation> {
            // Now make the actual call to the API
        ...
        public async getPendingInvitation(): Promise<GetPendingInvitationResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/guardians/invitations/me/pending`)
            return await resp.json() as GetPendingInvitationResponse
        }
...
export namespace questionnaires {
    ...
    export class ServiceClient {
        ...
        public async listQuestionnaires(organizationId: string): Promise<types.ListQuestionnairesResponse> {
            // Now make the actual call to the API
...
export namespace waivers {
    ...
    export class ServiceClient {
        ...
        public async listWaivers(organizationId: string): Promise<types.ListWaiversResponse> {
            // Now make the actual call to the API
