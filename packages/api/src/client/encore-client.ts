...
export namespace availability {
  export class ServiceClient {
    ...
    public async createTimeBlock(
      params: time_blocks.CreateTimeBlockRequest
    ): Promise<types.GetTimeBlockResponse> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        "POST",
        `/time-blocks`,
    ...
    public async listTimeBlocks(
      params: time_blocks.ListTimeBlocksRequest
    ...
    public async listTrainerBusinessHours(
      trainerId: string
    ): Promise<types.ListBusinessHoursResponse> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        "GET",
    ...
    public async updateOrganizationBusinessHours(
      params: business_hours.UpdateOrganizationBusinessHoursRequest
    ): Promise<void> {
      await this.baseClient.callTypedAPI(
        "PUT",
        `/business-hours/organization`,
    ...
    public async updateTimeBlock(
      id: string,
      params: time_blocks.UpdateTimeBlockRequest
    ): Promise<types.GetTimeBlockResponse> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        "PUT",
    ...
    public async updateTrainerBusinessHours(
      trainerId: string,
      params: business_hours.UpdateTrainerBusinessHoursRequest
...
export namespace boards {
  ...
  export class ServiceClient {
    ...
    public async listBoards(
      ...
      const query = makeRecord<string, string | string[]>({
        isTrainer:
          params.isTrainer === undefined ? undefined : String(params.isTrainer),
...
export namespace guardians {
  ...
  export class ServiceClient {
    ...
    ): Promise<types.GetGuardianRelationshipResponse> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        "POST",
        `/guardians/${encodeURIComponent(relationshipId)}/confirm`
      );
    ...
    public async createGuardianRelationship(
      ...
      params: CreateGuardianRelationshipRequest
    ): Promise<types.GetGuardianRelationshipResponse> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        "POST",
    ...
    public async getGuardianRelationships(
      guardianMemberId: string
    ): Promise<types.ListGuardianRelationshipsResponse> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        "GET",
        `/guardians/relationships/${encodeURIComponent(guardianMemberId)}`
      );
...
export namespace notifications {
  ...
  export class ServiceClient {
    ...
    public async getPreferences(
      memberId: string
    ): Promise<types.GetPreferencesResponse> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        "GET",
...
export namespace types {
  ...
  export type EffectiveDayHoursSource =
    | "board_override"
    | "organization_default"
    | "trainer_default"
    | "trainer_board_override";
  ...
  export interface ListBusinessHoursResponse {
    ...
    boardOverrides: {
      [key: string]: TrainerBusinessHours[] | OrganizationBusinessHours[];
    };
  }
